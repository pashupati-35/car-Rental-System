...
class UpdateCarRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'driver_photo' => 'nullable|file|mimes:jpeg,png,jpg,gif,svg,webp,bmp,tiff,tif,heic,heif,avif,jfif,pjpeg,pjp|max:5120',
            'licence_photo' => 'nullable|file|mimes:pdf,doc,docx,jpeg,png,jpg,gif,svg,webp,bmp,tiff,tif,heic,heif,avif,jfif,pjpeg,pjp|max:10240',
