    ...
    <header class="sticky top-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur border-b border-gray-100 dark:border-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
          <Link href="/" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 transition-colors">Home</Link>
          <Link href="/cars" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 transition-colors">Browse Cars</Link>
          <Link href="/car-calendar" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 transition-colors">Availability</Link>
          <Link href="/ai-chat" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 transition-colors flex items-center gap-1.5">
            <i class="ri-sparkling-fill text-amber-500"></i> AI Assistant
          </Link>
        </nav>
