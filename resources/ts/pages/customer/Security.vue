            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  class="w-full px-3.5 py-2.5 pe-10 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                <button
                  type="button"
