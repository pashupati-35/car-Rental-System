      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        ...
        <div>
          <div class="flex items-center justify-between mb-1.5">
            ...
            <Link href="/customer/forgot-password" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">
              Forgot password?
            </Link>
          </div>
          <input
        ...
        <div class="text-center pt-3">
          <p class="text-xs text-gray-500">
            ...
            <Link href="/customer/register" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline ms-1">
              Create free account
            </Link>
          </p>
        </div>
