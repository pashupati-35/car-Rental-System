      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        ...
        <div>
          <div class="flex items-center justify-between mb-1.5">
            ...
            <Link href="/owner/forgot-password" class="text-xs text-emerald-600 dark:text-emerald-400 hover:underline">
              Forgot password?
            </Link>
          </div>
          <input
        ...
        <button
          ...
          class="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold text-sm shadow-lg shadow-emerald-500/25 disabled:opacity-50 transition-all flex items-center justify-center gap-2 mt-2"
        >
        ...
        <div class="text-center pt-3">
          <p class="text-xs text-gray-500">
            ...
            <Link href="/owner/register" class="text-emerald-600 dark:text-emerald-400 font-semibold hover:underline ms-1">
              Register as Owner
            </Link>
          </p>
        </div>
