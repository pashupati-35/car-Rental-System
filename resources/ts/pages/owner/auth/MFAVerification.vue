  ...
  <div class="space-y-5">
    <div class="text-center mb-4">
      ...
      <p class="text-xs text-gray-500 mt-1 max-w-xs mx-auto">
        Please enter the code from your authenticator app to access your owner portal.
      </p>
    </div>
    ...
    <button
      :disabled="loading"
      class="w-full py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm shadow-lg shadow-emerald-500/25 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
      @click="verifyCode"
    >
