    ...
    <div class="space-y-4">
      <form class="space-y-3.5" @submit.prevent="submit">
        <div>
          ...
          />
          <span v-if="form.errors.full_name" class="text-xs text-red-500 mt-1 block">{{ form.errors.full_name }}</span>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            />
            <span v-if="form.errors.contact_number" class="text-xs text-red-500 mt-1 block">{{ form.errors.contact_number }}</span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value="other">Company / Organization</option>
            </select>
          </div>
        </div>
        ...
        <button
          ...
          class="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold text-sm shadow-lg shadow-emerald-500/25 disabled:opacity-50 transition-all flex items-center justify-center gap-2 mt-2"
        >
        ...
        <div class="text-center pt-2">
          <p class="text-xs text-gray-500">
            ...
            <Link href="/owner/login" class="text-emerald-600 dark:text-emerald-400 font-bold hover:underline ms-1">
      ...
      <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 flex justify-between text-xs text-gray-500">
        <Link href="/customer/register" class="hover:text-blue-600 transition-colors">Register as Customer &rarr;</Link>
        <Link href="/" class="hover:text-emerald-600 transition-colors">&larr; Back to Showroom</Link>
      </div>
    </div>
  </AuthLayout>
</template>
