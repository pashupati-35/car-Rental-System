...
<template>
  <AppLayout>
    <Head title="Security Settings - Owner" />
    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-2 text-xs">
        ...
        <button
          type="button"
          class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-emerald-600 border-emerald-200 bg-emerald-50/70 font-semibold"
        >
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p class="text-xs text-gray-500 mt-0.5">
            Manage your fleet authentication credentials and account security
          </p>
        </div>
        ...
        <div class="flex rounded-xl bg-gray-100 dark:bg-gray-800 p-1 text-xs font-semibold">
          <button
            type="button"
            :class="activeTab === 'security' ? 'bg-white dark:bg-gray-900 text-emerald-600 shadow-sm' : 'text-gray-600 dark:text-gray-400'"
          ...
          <button
            type="button"
            :class="activeTab === 'profile' ? 'bg-white dark:bg-gray-900 text-emerald-600 shadow-sm' : 'text-gray-600 dark:text-gray-400'"
            class="px-3.5 py-1.5 rounded-lg transition-all"
      ...
      <div v-if="activeTab === 'security'" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          ...
          <div class="p-6 space-y-6">
            ...
            <div
              v-if="showMfaSetup"
              class="p-5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/40 space-y-4"
            >
              ...
              <div class="flex flex-col sm:flex-row items-center gap-6">
                ...
                <div class="space-y-3 flex-1 text-xs">
                  ...
                  <div class="p-2.5 bg-white dark:bg-gray-800 rounded-lg font-mono font-bold text-emerald-600 border border-gray-200 dark:border-gray-700 select-all">
                    {{ secretKey }}
                  </div>
                  <div class="space-y-1 pt-1">
                    ...
                    <div class="flex gap-2">
                      <input
                        ...
                        maxlength="6"
                        placeholder="123456"
                        class="w-36 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 font-mono text-center tracking-widest text-sm focus:ring-2 focus:ring-emerald-500"
                      />
                      <button
                        type="button"
                        :disabled="mfaLoading"
                        class="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs shadow-md disabled:opacity-50"
                        @click="activateMfa"
                      >
            ...
            <div class="pt-2">
              ...
              <button
                ...
                type="button"
                :disabled="mfaLoading"
                class="w-full py-2.5 px-4 rounded-xl border border-emerald-200 bg-emerald-50/70 hover:bg-emerald-100 text-emerald-700 text-xs font-semibold flex items-center justify-center gap-2 transition-colors"
                @click="initMfaSetup"
              >
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          <div class="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500">Update your owner portal password</p>
            </div>
          </div>
          ...
          <form class="p-6 space-y-4" @submit.prevent="updatePassword">
            ...
            <div>
              ...
              <input
                ...
                required
                placeholder="••••••••"
                class="w-full max-w-md px-3.5 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-2 focus:ring-emerald-500"
              />
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  class="w-full px-3.5 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              <div>
      ...
      <div v-else class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-5">
        ...
        <form class="space-y-4" @submit.prevent="updateProfile">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:ring-2 focus:ring-emerald-500"
              />
            </div>
            <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Business Address</label>
              <input
          ...
          <div class="flex justify-end pt-2">
            <button
              ...
              class="px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs shadow-md shadow-emerald-500/20 disabled:opacity-50"
            >
