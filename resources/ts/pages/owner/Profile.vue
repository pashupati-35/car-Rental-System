...
const toggleEmailAuth = async () => {
  ...
  try {
    const endpoint = emailAuthEnabled.value ? '/owner/mfa/email/deactivate' : '/owner/mfa/email/activate'
...
<template>
  <AppLayout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p class="text-xs text-gray-500 mt-0.5">
            Manage your fleet owner credentials and account security
          </p>
        </div>
      ...
      >
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          <div class="p-6 border-b border-gray-100 dark:border-gray-800">
            ...
            <p class="text-xs text-gray-500 mt-0.5">
              Protect your fleet and business operations using authenticator apps
            </p>
          </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          <div class="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500">
                Update your owner portal password
              </p>
            </div>
          </div>
      ...
      <div
        v-else
        class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-5"
      >
        <div>
          <h3 class="text-base font-bold text-gray-900 dark:text-white">
            Fleet Owner Details
