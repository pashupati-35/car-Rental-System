  ...
  <AppLayout>
    ...
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h3 class="font-bold text-xl text-gray-900 dark:text-white">Customer Records</h3>
          <p class="text-xs text-gray-500 mt-0.5">Manage customer accounts, contact information and rental history</p>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
        <table class="w-full text-left text-sm">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
            <tr v-for="customer in customers" :key="customer.id" class="hover:bg-gray-50/50 dark:hover:bg-gray-800/40">
