      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-xs text-gray-500 mt-0.5">
            Manage vehicles, pricing, availability and fleet details
          </p>
        </div>
      </div>
        ...
        <table class="w-full text-left text-sm">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            >
              ...
              <td class="py-4 px-6">
                <span
                  :class="car.status === 'available' || !car.status ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-amber-50 text-amber-700'"
