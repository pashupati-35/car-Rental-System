  ...
  <AppLayout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h3 class="font-bold text-xl text-gray-900 dark:text-white">{{ template.title }}</h3>
          <p class="text-xs text-gray-500 font-mono mt-0.5">Identifier: {{ template.identifier }}</p>
        </div>
        <Link
      ...
      <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 shadow-sm">
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div v-if="template.accepted_inputs" class="p-3.5 rounded-xl bg-blue-50/70 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900 text-xs">
          ...
          <div class="flex items-center gap-2">
            ...
            />
            <label for="is_active" class="text-sm font-medium text-gray-700 dark:text-gray-300">Enable this template</label>
          </div>
