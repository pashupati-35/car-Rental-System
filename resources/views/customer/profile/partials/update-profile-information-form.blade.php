<section>
    ...
    <form method="post" action="{{ route('customer.profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <x-text-input id="full_name" name="full_name" type="text" class="input-field" :value="old('full_name', Auth::user()->name)" required autofocus autocomplete="name" />
        ...
        <div class="form-group">
            ...
            <x-text-input id="contact_number" name="contact_number" type="text" class="input-field" :value="old('contact_number', Auth::user()->phone_number)" required autocomplete="tel" />
            <x-input-error class="input-error" :messages="$errors->get('phone_number')" />
        </div>
