    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('site_settings')) {
            Schema::create('site_settings', function (Blueprint $table) {
                ...
                $table->boolean('enable_cookies')->default(1);
                $table->boolean('is_admission_form_active')->default(0);
                ...
                $table->decimal('tax_percentage', 8, 2)->nullable()->default(13.00);
                $table->string('pan_no')->nullable();
                $table->string('vat_no')->nullable();
                $table->string('seo_title')->nullable();
                $table->text('seo_keyword')->nullable();
                $table->text('seo_description')->nullable();
                $table->boolean('display_storage')->default(0);
                $table->boolean('display_smtp')->default(1);
                ...
                $table->text('storage_access_key')->nullable();
